...
int main(void) {
    static unsigned plain_text []={0x2234, 0x2678, 0x2389, 0x2992};
    static unsigned asso_text []={0xacac, 0xfefe, 0x8181, 0x5d5d};
    static unsigned cipher_text []= {0x0, 0x0, 0x0 , 0x0};
    static unsigned dumm_array []= {0x0, 0x0, 0x0, 0x0};
    unsigned plain_len = 8;
    unsigned asso_len = 0; /// CReo que asignaste a memoria
    unsigned plain_len_int = plain_len / 4 + 1;
