...
int main() {
    unsigned int highPart = 0x12345678;// Example high part (32 bits)
    unsigned int lowPart = 0x9abcdef0;  // Example low part (32 bits)
    int rotationAmount = 33; // Number of positions to rotate right
